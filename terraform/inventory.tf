# Формирование файла inventory для ansible
    ...
    db:
      hosts:
        ${yandex_compute_instance.my-sql[0].hostname}:
          ...
          ansible_user: ${var.os_username}
          ansible_ssh_extra_args: "-o StrictHostKeyChecking=no -J ${var.os_username}@${yandex_compute_instance.nginx1.network_interface[0].nat_ip_address}"
          cluster_role: 'master'
